...
// Map of service IDs to their corresponding icon URLs and alt text
const SERVICE_ICONS: Record<string, { src: string; alt: string }> = {
  'recovery-consultation': {
    src: 'https://images2.imgbox.com/e7/0f/yfQ894Tl_o.png',
    alt: 'Financial Scam Recovery Icon'
  },
  'investment-fraud': {
    src: 'https://images2.imgbox.com/76/6d/BSPbxZsR_o.png',
    alt: 'Investment Fraud Recovery Icon'
  },
  'cryptocurrency': {
    src: 'https://images2.imgbox.com/ba/78/wNqfvrmO_o.png',
    alt: 'Cryptocurrency Recovery Icon'
  },
  'regulatory': {
    src: 'https://images2.imgbox.com/f2/e9/tDfdd3sR_o.png',
                  ...
                  <motion.div variants={itemVariants}>
                    <ServiceHeader>
                      <ServiceIcon $backgroundColor={service.accentColor}>
                        <img 
                          src={SERVICE_ICONS[service.id]?.src}
                          alt={SERVICE_ICONS[service.id]?.alt}
                        />
                      </ServiceIcon>
                    ...
                    <motion.div variants={itemVariants}>
                      ...
                      >
                        ...
                        <TrustBadge>
                          ...
                          <TrustText>
                            FCA Regulated · Secure & Confidential Process
                          </TrustText>
                        </TrustBadge>
                      </ServiceDetailsCard>
                    </motion.div>
