...
export const ServiceDefinitionGrid = styled.div`
  display: grid;
...
export const ServiceDefinitionCard = styled.div`
  background: white;
  border: 2px solid ${PREMIUM_COLORS.border};
  border-radius: 8px;
  padding: ${PREMIUM_SPACING.xl}px;
...
export const LiabilityGrid = styled.div`
  display: grid;
...
export const LiabilityCard = styled.div`
  ...
  .liability-limit {
    background: ${PREMIUM_COLORS.warning}20;
